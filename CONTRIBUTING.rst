...
When `reporting a bug <https://github.com/metatooling/checkon/issues>`_ please include:
...
checkon could always use more documentation, whether as part of the
official checkon docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork `checkon <https://github.com/metatooling/checkon>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/metatooling/checkon/pull_requests>`_ for each change you add in the pull request.
